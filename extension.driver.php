	...
	Class extension_codemirror extends Extension {
		...
		public function __appendAdminPageAssets($context) {   
			if (!$this->adminHeadersAppended && Administration::instance()) {
				...
				Administration::instance()->Page->addScriptToHead(URL . '/extensions/codemirror/assets/js/init.js', 3066705);
				Administration::instance()->Page->addScriptToHead(URL . '/extensions/codemirror/assets/js/emmet.min.js', 3066703);
				Administration::instance()->Page->addScriptToHead(URL . '/extensions/codemirror/assets/js/customSnippets.js', 3066704);
